  ...
  [3],
  {
    ...
    275: function (t, e, r) {
      ...
      var g = {
          ...
          fgColor: a.default.string,
          level: a.default.oneOf(["L", "M", "Q", "H"]),
        ...
        d = function (t) {
          var e = t.bgColor,
            ...
            d = new o.default(-1, i.default[a]);
          d.addData(f), d.make();
          var c = d.modules,
            m = u / c.length;
          return s.default.createElement(
            h.default,
            n({}, g, { size: u, style: { height: u, width: u } }),
            c.map(function (t, n) {
              return t.map(function (t, o) {
                var i = t ? r : e,
                  a = Math.ceil((o + 1) * m) - Math.floor(o * m),
                  u = Math.ceil((n + 1) * m) - Math.floor(n * m),
                  h =
                    "M 0 0 L " + a + " 0 L " + a + " " + u + " L 0 " + u + " Z",
                  f = Math.round(o * m),
                  g = Math.round(n * m);
    ...
    276: function (t, e, r) {
      ...
      (l.addData = function (t) {
        ...
        (s.createData = function (t, e, r) {
          for (
            var n = o.getRSBlocks(t, e), u = new i(), l = 0;
            l < r.length;
            l++
          ) {
            var h = r[l];
        ...
        (s.createBytes = function (t, e) {
          for (
            ...
            for (g = 0; g < s[l].length; g++) {
              var m = g + c.getLength() - s[l].length;
              s[l][g] = m >= 0 ? c.get(m) : 0;
            }
          }
          var p = 0;
          ...
          for (g = 0; g < n; g++)
            for (l = 0; l < e.length; l++)
              g < i[l].length && (v[L++] = i[l][g]);
          for (g = 0; g < o; g++)
            for (l = 0; l < e.length; l++)
              g < s[l].length && (v[L++] = s[l][g]);
          return v;
        }),
        (t.exports = s);
    },
    ...
    281: function (t, e, r) {
      ...
      (u.propTypes = a), (u.defaultProps = {}), (e.default = u);
    },
    282: function (t, e, r) {
      "use strict";
      Object.defineProperty(e, "__esModule", { value: !0 });
      ...
      var u = {
        ...
        s = { style: void 0, xmlns: "http://www.w3.org/2000/svg" },
        l = function (t) {
          var e = t.children,
            r = t.size,
            o = t.style,
            ...
            u = (function (t, e) {
              ...
              for (var n in t)
                e.indexOf(n) >= 0 ||
                  (Object.prototype.hasOwnProperty.call(t, n) && (r[n] = t[n]));
              return r;
            })(t, ["children", "size", "style", "xmlns"]);
          return i.default.createElement(
            "svg",
            n({}, u, { height: r, style: o, width: r, xmlns: a }),
            e
          );
        };
      (l.propTypes = u), (l.defaultProps = s), (e.default = l);
    },
  },
]);
//# sourceMappingURL=3.17f84bc9.chunk.js.map
